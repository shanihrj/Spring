...
<body>
	<form name="success">
		...
		<input type="button" onclick="addNew()" value="AddNew"> <input
			type="button" onclick="del()" value="Delete"> <input
			type="button" onclick="edit()" value="Edit">
	</form>
</body>
</html>